...
- [La Voz De Los Que Sobran](https://lavozdelosquesobran.cl/)
...
- [Osorno TV](https://www.osornotv.cl/envivo.html)
...
- [Cámara de Diputados](https://webtv.camara.cl/)
...
+ <details>
	...
	- [Infinita](https://www.infinita.cl/)
...
+ <details>
    <summary>Radios Perú 🇵🇪</summary>

	- [Ovación TV](https://ovacion.pe/radio)
	
	- [Radio San Borja Tv](https://radiosanborjatv.com/)
	- [Radio Onda Digital](https://www.ondadigital.pe/)
	- [Radio Tropical](https://radiotropical.pe/)
	- [Radio Uno](https://www.youtube.com/channel/UCK0lpuL9PQb3I5CDcu7Y7bA)
...
```
 "noticiero-generico": {
        ...
        "señales": {
            ...
            "m3u8_url": [
                "https://....m3u8"   // enlaces ".m3u8", no listas ".m3u". Solo canales individuales.
            ],
            "yt_id": "",     // ID referente a un canal de Youtube [https://www.youtube.com/channel/"yt_id"]. No YOUTUBE HANDLE de canal (@nombre), herramienta https://commentpicker.com/youtube-channel-id.php
            "yt_embed": "",
            "yt_playlist": "",
            "twitch_id": ""
        },
        "sitio_oficial": "https://www.24horas.cl/envivo/",
        "país": "cl",           // (nombre país es en base a ISO 3166, https://flagcdn.com/en/codes.json (Recomendable en minúsculas))
        "categoría": "news"
    }
```